...
namespace CYEngine
{
	public class BookDragDrop : MonoBehaviour
	{
		...
		[System.NonSerialized] static public List<BookDragDrop> draggedItems = new List<BookDragDrop>();
		...
		public virtual BookDragDrop StartDragging()
		{
